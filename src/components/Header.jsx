...
function Header() {
  ...
  return (
    <header className="w-full bg-white/80 backdrop-blur shadow-sm border-b border-gray-200 px-10 py-4 flex items-center justify-between sticky top-0 z-20 transition-colors duration-300 dark:bg-gray-900/80 dark:border-gray-800">
      <h1 className="text-3xl font-bold tracking-wide text-green-600 dark:text-green-400">
        Toopus
      </h1>
      ...
      <nav>
        <ul className="flex items-center gap-8 font-medium text-gray-700 dark:text-gray-100">
          <li>
            <Link
              to="/"
              className="flex items-center gap-2 text-lg transition-colors hover:text-green-600 dark:hover:text-green-400"
            >
              <IoHome className="text-green-600 dark:text-green-400" />
              Home
            </Link>
          </li>
          ...
          <li>
            <Link
              ...
              className="flex items-center gap-2 text-lg transition-colors hover:text-green-600 dark:hover:text-green-400"
            >
              <FaSearch className="text-green-600 dark:text-green-400" />
              Search
            </Link>
          </li>
          ...
          <li>
            <Link
              ...
              className="flex items-center gap-2 text-lg transition-colors hover:text-green-600 dark:hover:text-green-400"
            >
              <FaUserFriends className="text-green-600 dark:text-green-400" />
              Connection
            </Link>
          </li>
