      ...
      <nav>
        <ul className="flex items-center gap-10 text-700 font-medium">
          <li>
            <Link
              to={"/"}
              className="flex items-center gap-2 text-lg hover:text-green-600 transition-colors">
              <IoHome className="text-green-600"/>Home</Link>
          </li>
          <li>
          ...
          <li>
            <Link to={"/conectar"} className="flex items-center gap-2 text-lg hover:text-green-600 transition-colors">
              <FaUserFriends className="text-green-600"/>Connection</Link>
          </li>
        </ul>
      </nav>
    </header>
